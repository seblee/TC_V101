...
//    time_t now;
//		struct tm* ti;
//		int16_t year,month,day,hour,min,sec;	 
//		
//    time(&now);
//		ti = localtime(&now);		
//		
...
//		sec = ti->tm_sec;
//		
//		gds_sys_ptr->status.sys_time.year_month = (year<<8)|month;
//		gds_sys_ptr->status.sys_time.day_hour = (day<<8)|hour;
//		gds_sys_ptr->status.sys_time.min_sec = (min<<8)|sec;
//}
