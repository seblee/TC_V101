...
*******************************************************************************/
  ...
  uint32_t SystemCoreClock         = HSI_PLL_VALUE;        /*!< System Clock Frequency (Core Clock) */
#endif
...
static void HSI_Conf(void)
{
        ...
        //PLL?? SYSCLK/2 * 12 = 4*16 = 64MHz
        RCC_PLLConfig(RCC_PLLSource_HSI_Div2, RCC_PLLMul_16);
        //??PLL
        RCC_PLLCmd(ENABLE);//??PLL???????,???DISABLE
        //??PLL??
